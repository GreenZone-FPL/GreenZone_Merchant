import { StyleSheet, Text, ScrollView, processColor, TouchableOpacity } from 'react-native';
  ...
  return (
    <ScrollView showsVerticalScrollIndicator={false} contentContainerStyle={styles.container}>
      ...
      <Column style={styles.card}>
        ...
        <Text style={styles.cardTitle}>{currentMonth > 0 ? 'So với tháng trước' : 'Tháng trước không có dữ liệu'}</Text>
        {currentMonth > 0 ? (
          <Row style={{ gap: 8 }}>
            <Icon source={isIncrease ? 'chevron-up-circle' : 'chevron-down-circle'} size={20} color={isIncrease ? colors.primary : colors.red900} />
            <Text style={[styles.cardValue, !isIncrease && { color: colors.red900 }]}>{revenueChange.toFixed(2)}%</Text>
          </Row>
